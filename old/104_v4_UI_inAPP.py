...
def go_crawling():
    ...
    cur_path = pathlib.Path.cwd().parent.parent.parent
    csv_file = open(cur_path / f'{keyword}_{pages}頁.csv', 'w', encoding='utf_8_sig')
    ...
    columns = ['技能名稱', '出現次數']
    specialty_csv_file = open(cur_path / f'{keyword}_{pages}頁_specialty.csv', 'w', encoding='utf_8_sig')
